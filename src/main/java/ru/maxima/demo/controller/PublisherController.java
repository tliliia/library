...
public class PublisherController {
    ...
    @GetMapping
    public ResponseEntity<ProductPage> getAllPublishers(
    ...
    @PostMapping
    public ResponseEntity<ProductDto> addPublisher(@RequestBody ProductDto dto) {
    ...
    @GetMapping("/search")
    public ResponseEntity<ProductPage> searchPublishersByText(
